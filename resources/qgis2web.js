...
map.getView().fit([12071784.465499, -820446.276666, 12202689.607798, -750552.022535], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Peta Cuaca Ekstrem Kabupaten Brebes Maret 2026</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (124 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Ini adalah peta kejadian cuaca ekstrem di Kabupaten Brebes pada bulan Maret 2026, sumber data dihimpun oleh BPBD Kab. Brebes';
            }
